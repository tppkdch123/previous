...
public class BlogsAdapter extends BaseAdapter {
    ...
    public BlogsAdapter(Context c,List<blog> L){
        context=c;
        blogs=L;
    }
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            BlogsAdapter.HolderView holderView=new BlogsAdapter.HolderView();
            ...
            BlogsAdapter.HolderView holderView=(BlogsAdapter.HolderView) convertView.getTag();
            ...
            holderView.textView9.setText(new Integer(blogs.get(position).getFloornumber()).toString());
        return convertView;
    }
